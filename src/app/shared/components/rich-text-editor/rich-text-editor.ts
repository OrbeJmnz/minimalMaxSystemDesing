...
@Component({
  ...
  template: `
    ...
    <style>
      ...
      .mm-rte-content :where(b, strong) { font-weight: 700; }
      .mm-rte-content :where(i, em) { font-style: italic; }
      .mm-rte-content u { text-decoration: underline; }
      .mm-rte-content s { text-decoration: line-through; }
      .mm-rte-content ul { padding-left: 1.5rem; list-style: disc; margin: 0.5rem 0; }
      .mm-rte-content ol { padding-left: 1.5rem; list-style: decimal; margin: 0.5rem 0; }
      .mm-rte-content a {
