...
@Component({
  ...
  template: `
    ...
    >
      <header class="flex items-center justify-between px-4 py-2 border-b border-white/10 bg-white/5">
      ...
      <pre class="overflow-x-auto text-xs font-mono leading-relaxed mm-scroll-thin"><code>@for (line of diffLines(); track $index) {<span
              class="block px-4"
