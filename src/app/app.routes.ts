...
export const routes: Routes = [
  ...
  },
  {
    path: 'inbox',
    loadComponent: () =>
      import('./features/inbox/inbox').then((m) => m.InboxComponent),
  ...
  },
  {
    path: 'comments',
    loadComponent: () =>
      import('./features/comments/comments').then((m) => m.CommentsComponent),
    title: 'Comments · MinimalMax Components',
  },
  {
    path: 'diff',
    loadComponent: () =>
      import('./features/diff/diff').then((m) => m.DiffComponent),
    title: 'Diff Viewer · MinimalMax Components',
  },
  {
    path: 'marketing',
    loadComponent: () =>
      import('./features/marketing/marketing').then((m) => m.MarketingComponent),
  ...
  },
  {
    path: 'buttons',
    loadComponent: () =>
      import('./features/buttons/buttons').then((m) => m.ButtonsComponent),
    title: 'Buttons · MinimalMax Components',
  },
  {
    path: 'inputs',
    loadComponent: () =>
      import('./features/inputs/inputs').then((m) => m.InputsComponent),
  ...
  },
  {
    path: 'forms',
    loadComponent: () =>
      import('./features/forms/forms').then((m) => m.FormsComponent),
    title: 'Forms · MinimalMax Components',
  },
  {
    path: 'forms-advanced',
    loadComponent: () =>
      import('./features/forms-advanced/forms-advanced').then(
        (m) => m.FormsAdvancedComponent,
      ),
  ...
  },
  {
    path: 'badges',
    loadComponent: () =>
      import('./features/badges/badges').then((m) => m.BadgesComponent),
  ...
  },
  {
    path: 'kanban',
    loadComponent: () =>
      import('./features/kanban/kanban').then((m) => m.KanbanComponent),
  ...
  },
  {
    path: 'social',
    loadComponent: () =>
      import('./features/social/social').then((m) => m.SocialComponent),
    title: 'Social feed · MinimalMax Components',
  },
  {
    path: 'tour',
    loadComponent: () =>
      import('./features/tour/tour').then((m) => m.TourComponent),
    title: 'Tour · MinimalMax Components',
  },
  {
    path: 'overlays',
    loadComponent: () =>
      import('./features/overlays/overlays').then((m) => m.OverlaysComponent),
    title: 'Overlays · MinimalMax Components',
  },
  {
    path: 'dropdown',
    loadComponent: () =>
      import('./features/dropdown/dropdown').then((m) => m.DropdownComponent),
  ...
  },
  {
    path: 'exports',
    loadComponent: () =>
      import('./features/exports/exports').then((m) => m.ExportsComponent),
    title: 'Exports · MinimalMax Components',
  },
  {
    path: 'maps',
    loadComponent: () =>
      import('./features/maps/maps').then((m) => m.MapsComponent),
    title: 'Maps · MinimalMax Components',
  },
  {
    path: 'layouts',
    loadComponent: () =>
      import('./features/layouts/layouts').then((m) => m.LayoutsComponent),
  ...
  },
  {
    path: 'states',
    loadComponent: () =>
      import('./features/states/states').then((m) => m.StatesComponent),
