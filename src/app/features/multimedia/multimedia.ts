...
export class MultimediaComponent {
  ...
  protected readonly tasks = signal<readonly Task[]>([
    ...
    { id: 't4', title: 'Auditar accesibilidad de los modales', tone: 'from-amber-500 to-orange-500' },
  ...
  protected readonly images: readonly GalleryShot[] = [
    { src: 'https://images.unsplash.com/photo-1517816743773-6e0fd518b4a6?w=600&q=70&auto=format&fit=crop', alt: 'Galaxia espiral', tag: 'Cosmos' },
    { src: 'https://images.unsplash.com/photo-1532465614-6cc8d45f647f?w=600&q=70&auto=format&fit=crop', alt: 'Onda violeta', tag: 'Abstracto' },
    { src: 'https://images.unsplash.com/photo-1574169208507-84376144848b?w=600&q=70&auto=format&fit=crop', alt: 'Estrellas y nebulosa', tag: 'Cosmos' },
    { src: 'https://images.unsplash.com/photo-1465101046530-73398c7f28ca?w=600&q=70&auto=format&fit=crop', alt: 'Ciudad neón', tag: 'Urbano' },
    { src: 'https://images.unsplash.com/photo-1518837695005-2083093ee35b?w=600&q=70&auto=format&fit=crop', alt: 'Ola del océano', tag: 'Naturaleza' },
    { src: 'https://images.unsplash.com/photo-1465056836041-7f43ac27dcb5?w=600&q=70&auto=format&fit=crop', alt: 'Nebulosa rosa', tag: 'Cosmos' },
  ];

  protected readonly masonryImages: readonly (GalleryShot & { height: number })[] = [
    { src: 'https://images.unsplash.com/photo-1503614472-8c93d56e92ce?w=500&q=70&auto=format&fit=crop', alt: 'Montaña al atardecer', height: 280 },
    { src: 'https://images.unsplash.com/photo-1518770660439-4636190af475?w=500&q=70&auto=format&fit=crop', alt: 'Circuito tech', height: 200 },
    { src: 'https://images.unsplash.com/photo-1493244040629-496f6d136cc3?w=500&q=70&auto=format&fit=crop', alt: 'Bosque verde', height: 360 },
    { src: 'https://images.unsplash.com/photo-1505765050516-f72dcac9c60e?w=500&q=70&auto=format&fit=crop', alt: 'Sky reflejo', height: 240 },
    { src: 'https://images.unsplash.com/photo-1485470733090-0aae1788d5af?w=500&q=70&auto=format&fit=crop', alt: 'Cordillera con nubes', height: 320 },
    { src: 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=500&q=70&auto=format&fit=crop', alt: 'Carretera infinita', height: 220 },
    { src: 'https://images.unsplash.com/photo-1518837695005-2083093ee35b?w=500&q=70&auto=format&fit=crop', alt: 'Ola al amanecer', height: 280 },
    { src: 'https://images.unsplash.com/photo-1465101046530-73398c7f28ca?w=500&q=70&auto=format&fit=crop', alt: 'Neon city', height: 200 },
  ];

  protected readonly bentoImages: readonly GalleryShot[] = [
    { src: 'https://images.unsplash.com/photo-1517816743773-6e0fd518b4a6?w=900&q=70&auto=format&fit=crop', alt: 'Galaxia espiral grande' },
    { src: 'https://images.unsplash.com/photo-1532465614-6cc8d45f647f?w=600&q=70&auto=format&fit=crop', alt: 'Onda violeta' },
    { src: 'https://images.unsplash.com/photo-1574169208507-84376144848b?w=600&q=70&auto=format&fit=crop', alt: 'Estrellas' },
    { src: 'https://images.unsplash.com/photo-1465101046530-73398c7f28ca?w=600&q=70&auto=format&fit=crop', alt: 'Ciudad neón' },
    { src: 'https://images.unsplash.com/photo-1518837695005-2083093ee35b?w=600&q=70&auto=format&fit=crop', alt: 'Ola del océano' },
  ];

  protected readonly polaroidImages: readonly (GalleryShot & { rotation: string })[] = [
    { src: 'https://images.unsplash.com/photo-1503614472-8c93d56e92ce?w=400&q=70&auto=format&fit=crop', alt: 'Atardecer', rotation: '-rotate-3' },
    { src: 'https://images.unsplash.com/photo-1505765050516-f72dcac9c60e?w=400&q=70&auto=format&fit=crop', alt: 'Reflejo', rotation: 'rotate-2' },
    { src: 'https://images.unsplash.com/photo-1493244040629-496f6d136cc3?w=400&q=70&auto=format&fit=crop', alt: 'Bosque', rotation: '-rotate-1' },
    { src: 'https://images.unsplash.com/photo-1485470733090-0aae1788d5af?w=400&q=70&auto=format&fit=crop', alt: 'Cumbres', rotation: 'rotate-3' },
  ];
  ...
  protected onPanStart(event: PointerEvent): void {
    ...
    this.panStart = { x: event.clientX - this.previewPan().x, y: event.clientY - this.previewPan().y };
