...
export class BadgesComponent {
  protected readonly team: readonly TeamMember[] = [
    { name: 'Orbe Jimenez', role: 'Lead Dev', initials: 'OJ', tone: 'from-brand-6 to-primary-500', status: 'online' },
    { name: 'Sofia Reyes', role: 'Design', initials: 'SR', tone: 'from-brand-pink to-fuchsia-500', status: 'online' },
    { name: 'Diego Luna', role: 'Backend', initials: 'DL', tone: 'from-emerald-500 to-teal-500', status: 'away' },
    { name: 'Ana Vega', role: 'Product', initials: 'AV', tone: 'from-amber-500 to-orange-500', status: 'offline' },
    { name: 'Luis Mora', role: 'QA', initials: 'LM', tone: 'from-violet-500 to-indigo-500', status: 'online' },
  ];

  protected readonly stats = [
    { label: 'Componentes', value: '70+', trend: '+8', icon: 'M3 3h18v18H3z' },
    { label: 'Bundle inicial', value: '74 kB', trend: '-12%', icon: 'M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z' },
    { label: 'Build time', value: '0.4s', trend: '⚡', icon: 'M13 2 3 14h9l-1 8 10-12h-9l1-8z' },
    { label: 'A11y score', value: '98', trend: 'AAA', icon: 'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z' },
  ];
