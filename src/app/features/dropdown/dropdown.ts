...
export class DropdownComponent implements AfterViewInit {
  ...
  protected readonly menuItems: readonly MenuItem[] = [
    { id: 'duplicate', label: 'Duplicar', icon: 'M20 9h-9a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2v-9a2 2 0 0 0-2-2zM5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1', shortcut: '⌘D' },
    { id: 'share', label: 'Compartir', icon: 'M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8M16 6l-4-4-4 4M12 2v13', shortcut: '⌘S' },
    { id: 'archive', label: 'Archivar', icon: 'M21 8v13H3V8M1 3h22v5H1zM10 12h4' },
    { id: 'delete', label: 'Eliminar…', icon: 'M3 6h18M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2', destructive: true },
  ];
  ...
  protected readonly commands: readonly CommandItem[] = [
    { id: 'nav-overview', label: 'Ir a Overview', hint: 'Página principal', group: 'Navegar', icon: 'M3 9 12 2l9 7v11a2 2 0 0 1-2 2h-3a2 2 0 0 1-2-2v-5h-4v5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z', action: () => this.router.navigateByUrl('/overview') },
    { id: 'nav-buttons', label: 'Ir a Buttons', hint: '5 variantes + ripple', group: 'Navegar', icon: 'M7 8h10M7 12h10M7 16h4', action: () => this.router.navigateByUrl('/buttons') },
    { id: 'nav-inputs', label: 'Ir a Inputs', hint: 'Floating labels', group: 'Navegar', icon: 'M3 6h18M3 12h18M3 18h12', action: () => this.router.navigateByUrl('/inputs') },
    { id: 'nav-forms', label: 'Ir a Forms', hint: 'Select · Check · Radio', group: 'Navegar', icon: 'M3 9 12 2l9 7v11a2 2 0 0 1-2 2h-3a2 2 0 0 1-2-2v-5h-4v5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z', action: () => this.router.navigateByUrl('/forms') },
    { id: 'nav-cards', label: 'Ir a Cards', hint: 'Gradient + glass', group: 'Navegar', icon: 'M3 3h7v7H3zM14 3h7v7h-7zM3 14h7v7H3zM14 14h7v7h-7z', action: () => this.router.navigateByUrl('/cards') },
    { id: 'nav-data', label: 'Ir a Data', hint: 'Table · Accordion · Timeline', group: 'Navegar', icon: 'M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z', action: () => this.router.navigateByUrl('/data-display') },
    { id: 'theme-toggle', label: 'Cambiar tema', hint: 'Light ↔ Dark', group: 'Acciones', icon: 'M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9z', action: () => document.documentElement.toggleAttribute('data-theme') },
    { id: 'github', label: 'Abrir GitHub', hint: 'Repositorio del proyecto', group: 'Acciones', icon: 'M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22', action: () => window.open('https://github.com', '_blank') },
  ];
  ...
  protected readonly filteredCommands = computed(() => {
    ...
    return this.commands.filter(
      (cmd) =>
        cmd.label.toLowerCase().includes(term) || cmd.hint.toLowerCase().includes(term),
    );
  });
