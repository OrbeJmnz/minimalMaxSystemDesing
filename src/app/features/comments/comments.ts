...
export class CommentsComponent {
  ...
  protected readonly composerRef =
  ...
  protected readonly thread = signal<Comment[]>([
    {
      ...
      body:
        'Hola equipo! Pasé el wireframe del onboarding por una segunda iteración. Creo que el paso 3 (goals selection) se siente denso visualmente — son 6 cards y la grid se ve como un menú. ¿Qué opinan de reducir a 4 categorías principales con sub-tags?',
      ...
      replies: [
        {
          ...
          body:
            'Estoy de acuerdo. @ana ¿podemos revisar si las 6 categorías vienen de research o las inventamos nosotros?',
        ...
        },
        {
          ...
          body:
            '@diego buena observación. Salieron del workshop de febrero pero podemos hacer card sorting con 5 usuarios la próxima semana para validar.',
  ...
  protected readonly threadSummaries: readonly ThreadSummary[] = [
    {
      ...
      participants: [
        this.mentionableUsers[0],
        this.mentionableUsers[1],
        this.mentionableUsers[2],
      ],
      replies: 12,
      resolved: false,
    ...
    },
    {
      ...
      snippet: 'Estoy probando Outfit como display y DM Sans como UI. La proporción entre weights se siente…',
    ...
    },
    {
      ...
      participants: [
        this.mentionableUsers[1],
        this.mentionableUsers[3],
        this.mentionableUsers[4],
      ],
      replies: 23,
      resolved: false,
      lastActivity: 'Ayer',
