...
export class MarkdownFeatureComponent {
  ...
  protected readonly toolbar: readonly ToolbarAction[] = [
    { id: 'bold', label: 'Negrita', icon: 'M6 4h8a4 4 0 0 1 0 8H6zM6 12h9a4 4 0 0 1 0 8H6z', shortcut: '⌘B' },
    ...
    { id: 'quote', label: 'Cita', icon: 'M3 21c3 0 7-1 7-8V5c0-1.25-.756-2.017-2-2H4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 1 0 1 0 1 1v1c0 1-1 2-2 2s-1 .008-1 1.031V20c0 1 0 1 1 1zM15 21c3 0 7-1 7-8V5c0-1.25-.757-2.017-2-2h-4c-1.25 0-2 .75-2 1.972V11c0 1.25.75 2 2 2 .985 0 1 0 1 1v1c0 1-1 2-2 2-.985 0-1 .008-1 1.031V20c0 1 0 1 1 1z' },
    { id: 'code', label: 'Código', icon: 'm16 18 6-6-6-6M8 6l-6 6 6 6' },
    { id: 'link', label: 'Link', icon: 'M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71' },
    { id: 'image', label: 'Imagen', icon: 'M3 3h18v18H3zM8.5 11a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM21 15l-5-5L5 21' },
  ];
...
<!-- previewHtml() es un computed que llama toHtml(source()).
  ...
  private toHtml(md: string): string {
    ...
    src = src.replace(
      /^---+$/gm,
      '<hr class="my-5 border-t border-border-soft" />',
    );
