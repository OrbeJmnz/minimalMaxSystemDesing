...
export class CardsComponent {
  ...
  protected readonly aiCards = [
    ...
    { name: 'MinimalMax Chat', tag: 'LLM', icon: 'M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-15.6-.6L3 21l1.9-1.5a8.38 8.38 0 0 0 3.8.9' },
    { name: 'Music-01', tag: 'Audio', icon: 'M9 18V5l12-2v13M9 13l12-2M6 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z' },
  ];
