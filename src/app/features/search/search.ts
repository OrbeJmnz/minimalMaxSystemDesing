...
export class SearchComponent {
  ...
  protected readonly typeOptions: readonly { id: SearchResult['type']; label: string; icon: string }[] = [
    { id: 'doc', label: 'Documentos', icon: 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z' },
    { id: 'person', label: 'Personas', icon: 'M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z' },
    { id: 'code', label: 'Código', icon: 'm16 18 6-6-6-6M8 6l-6 6 6 6' },
    { id: 'image', label: 'Imágenes', icon: 'M3 3h18v18H3zM8.5 11a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM21 15l-5-5L5 21' },
  ];
  ...
  protected typeMeta(type: SearchResult['type']): { icon: string; tone: string } {
    switch (type) {
      case 'doc':
        return { icon: 'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z', tone: 'bg-primary-200 text-primary-700' };
      case 'person':
        return { icon: 'M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z', tone: 'bg-success-bg text-success' };
      case 'code':
        return { icon: 'm16 18 6-6-6-6M8 6l-6 6 6 6', tone: 'bg-brand-pink/15 text-brand-pink' };
      case 'image':
        return { icon: 'M3 3h18v18H3zM8.5 11a2 2 0 1 1 0-4 2 2 0 0 1 0 4z', tone: 'bg-warning-bg text-warning' };
    }
  }
