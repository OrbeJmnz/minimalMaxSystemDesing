...
@Component({
  ...
  imports: [CanvasFrameComponent, SectionHeaderComponent, ModalShellComponent, RippleDirective],
...
export class SettingsComponent {
  ...
  protected readonly canDelete = computed(() => this.deleteConfirm() === 'ELIMINAR');
